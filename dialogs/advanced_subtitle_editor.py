...
Dialog ini menyediakan tampilan video yang lebih besar dan kontrol detail untuk mengedit subtitle,
termasuk timing, styling, dan teks subtitle.
"""
import os
from PySide6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QPushButton, 
                              QLabel, QTextEdit, QComboBox, QSlider, QSpinBox,
                              QTableWidget, QTableWidgetItem, QHeaderView, 
                              QTabWidget, QWidget, QSplitter, QFrame, QListWidget,
                              QMessageBox, QTimeEdit, QMenu, QToolButton,
                              QGraphicsScene, QGraphicsView)
from PySide6.QtCore import Qt, QTime, QUrl, Signal, Slot, QRectF
from PySide6.QtGui import QAction, QColor, QKeySequence, QUndoStack, QUndoCommand, QPainter, QFont
